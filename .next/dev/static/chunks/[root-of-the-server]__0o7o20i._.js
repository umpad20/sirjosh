...
"[project]/library/pages/login.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Login() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Login.useEffect": ()=>{
            if (router.query.registered) setSuccess(true);
        }
    }["Login.useEffect"], [
        router.query
    ]);
    ...
    async function handleSubmit(e) {
        ...
        setSuccess(false);
        try {
            const { data, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email: form.email,
                password: form.password
            });
            if (authError) throw authError;
            if (data.user) {
                // Fetch role to confirm login worked and user exists
                const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', data.user.id).single();
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    success && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: "Account created! Please sign in."
                    }, void 0, false, {
                        fileName: "[project]/library/pages/login.js",
                        lineNumber: 68,
                        columnNumber: 23
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        "aria-busy": loading,
                        "aria-label": "Sign in",
                        children: loading ? 'Searching...' : 'Sign In'
                    }, void 0, false, {
                        fileName: "[project]/library/pages/login.js",
                        lineNumber: 83,
                        columnNumber: 11
...
_s(Login, "9MjofsnpcW8zhlXQR1pVX99ei/A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/library/pages/login.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/login";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/library/pages/login.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/library/pages/login\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/library/pages/login.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__0o7o20i._.js.map