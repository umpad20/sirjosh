...
function Login() {
    ...
    async function handleSubmit(e) {
        ...
        setSuccess(false);
        try {
            const { data, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email: form.email,
            ...
            if (data.user) {
                ...
                const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$library$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', data.user.id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pix_jj._.js.map